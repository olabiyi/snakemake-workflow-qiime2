#!/bin/bash
#SBATCH --job-name=Assign-taxonomy      #Set the job name to "JobExample2"
...
#SBATCH --output=assign-tax.o.%j      #Send stdout/err to "Example2Out.[jobID]" 
#SBATCH --error=assign-tax.e.%j    #Send std err to "Example2error.[jobID]"
...
snakemake -pr  \
        ...
        "06.Assign_taxonomy/taxonomy.qzv" "07.Build_phylogenetic_tree/rooted-tree.qza" "08.Filter_feature_table/taxa_filtered_table.qzv"
